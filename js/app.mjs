 ...
 *
 * If you have any questions related to code, you can drop them in my Twitter DM @k4ran909
 * or in my email at itz.karanraj@gmail.com
 *
...
fetch(
  'https://api.github.com/repos/AellyRbot/Aelly.ai/contributors'
)
  .then((res) => res.json())
  .then((res) => {
